...
"""
        ...
        assert any("missing_type" in t for t in exc_info.value.missing_types)
...
"""
        ...
        assert any("cdc-cdo" in t for t in exc_info.value.missing_types)
...
"""
        ...
        assert any("cdo-cdc-cdo" in t for t in exc_info.value.missing_types)
